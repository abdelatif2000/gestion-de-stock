<div class="iq-sidebar sidebar-default">
    <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
        ...
        <div style="cursor:pointer" class="side-menu-bt-sidebar">
                <svg class="wrapper-menu" version="1.1" id="Capa_1" height="20" width="20" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 489.5 489.5"
                    style="enable-background:new 0 0 489.5 489.5;" xml:space="preserve">
                    <g>
                        <g>
                            <g>
